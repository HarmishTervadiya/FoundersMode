...
export default function MigrationScreen() {
  ...
  useEffect(() => {
    console.log(
      '[Migration] Mount check - secretKey:',
      secretKey,
      'userId:',
      userId,
      'hasStarted:',
  ...
  useEffect(() => {
    console.log(
      '[Migration] Completion check - migratedStats:',
      !!migratedStats,
      'isMigrating:',
      isMigrating,
      'hasCompleted:',
    ...
    <View style={styles.container} className={`theme-${themeKey}`}>
      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.logoContainer}>
          <View
            style={[styles.logo, { borderColor: themeColor, backgroundColor: `${themeColor}15` }]}
          >
        ...
        <Text style={[styles.subMessage, { color: `${themeColor}80` }]}>{decorativeMessage}</Text>
