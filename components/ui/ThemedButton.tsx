        ...
        >
            {({ pressed }) => (
                <>
                    ...
                    <View className={`py-5 px-6 ${pressed ? 'opacity-80' : ''} flex-row items-center justify-center gap-2`}>
                        {icon}
                        <Text className={`text-sm font-bold tracking-widest uppercase ${styles.text}`}>
                            {children}
                        </Text>
                    </View>
                </>
